    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex justify-center">
      <div className="w-full max-w-md bg-white border border-gray-200 p-10 shadow-sm rounded-lg">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-serif text-jade-900">Đặt Lại Mật Khẩu Quản Trị</h2>
        ...
        {success ? (
          <div className="text-center">
            ...
            <button 
              ...
              className="w-full bg-jade-800 text-white font-medium py-3 hover:bg-jade-900 transition-all rounded-md"
            >
              Đăng Nhập Quản Trị
            </button>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-1">
              ...
              <input 
                className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-jade-500 focus:border-jade-500 sm:text-sm"
                placeholder="••••••••" 
                type="password"
                value={password}
            ...
            <button 
              ...
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-jade-800 hover:bg-jade-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-jade-500 disabled:opacity-50"
            >
