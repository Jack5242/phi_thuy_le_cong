...
const RegisterView: React.FC<RegisterViewProps> = ({ onNavigate }) => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-playfair text-emerald-900 mb-6 text-center">Create Account</h2>
      ...
      <p className="mt-6 text-center text-sm text-gray-600">
        ...
        <button onClick={() => onNavigate('login')} className="text-emerald-700 hover:underline font-medium">
          Sign In
        </button>
      </p>
    </motion.div>
