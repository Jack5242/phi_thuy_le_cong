...
export const HomeView: React.FC<HomeViewProps> = ({ setView, setSelectedProduct, products }) => {
  ...
  return (
    <div className="space-y-12 pb-12">
      ...
      {promotionsLoaded ? (
        <section className="relative h-[600px] md:h-[800px] bg-teal-900 overflow-hidden group/slider">
              ...
              <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-start">
                <div className="max-w-2xl">
                  <motion.span
                    ...
                    className="text-teal-100 text-sm md:text-base font-bold uppercase tracking-[0.3em] mb-4 block"
                  >
                  ...
                  <motion.h2
                    ...
                    className="text-white text-5xl md:text-7xl font-playfair tracking-tight mb-4 leading-tight"
                  >
                  ...
                  <motion.button
                    ...
                    className="bg-white text-teal-900 px-10 py-4 text-sm md:text-base font-bold rounded-sm hover:bg-teal-50 transition-all uppercase tracking-widest shadow-xl"
                  >
        ...
        <section className="relative h-[600px] md:h-[800px] bg-teal-900 overflow-hidden">
          <div className="absolute inset-0 bg-teal-800 animate-pulse">
            <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-start">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="flex items-end justify-between mb-8">
          <div className="space-y-2">
            ...
            <h2 className="text-5xl md:text-6xl font-playfair text-teal-900 tracking-tight italic drop-shadow-sm">{t('home.new.title')}</h2>
          </div>
          <div className="flex items-center gap-4">
            <button
              onClick={() => setView('collections')}
              className="text-teal-900 font-bold flex items-center gap-2 hover:gap-3 transition-all group ml-4"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-8">
            <div className="space-y-2">
              ...
              <h2 className="text-5xl md:text-6xl font-playfair text-teal-900 tracking-tight italic drop-shadow-sm">{t('home.best.title')}</h2>
            </div>
            <div className="flex items-center gap-4">
              <button
                onClick={() => setView('collections')}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="absolute -bottom-8 -right-8 bg-teal-900 text-white p-8 hidden md:block max-w-xs shadow-2xl">
              <p className="text-sm italic font-playfair leading-relaxed">
                "{t('home.story.quote')}"
              </p>
              <p className="mt-4 font-bold text-xs uppercase tracking-widest"> {t('home.story.author')}</p>
            </div>
          </div>
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="space-y-4">
              <span className="text-teal-700 font-bold tracking-[0.3em] text-xs uppercase">{t('home.story.subtitle')}</span>
              <h2 className="text-4xl md:text-5xl font-playfair text-teal-900 leading-tight tracking-tight">
                {t('home.story.title')}
              </h2>
            </div>
            ...
            <button
              onClick={() => setView('collections')}
              className="border-2 border-teal-900 text-teal-900 px-10 py-4 font-black hover:bg-teal-900 hover:text-white transition-all rounded-sm uppercase tracking-widest text-sm"
            >
              {t('home.story.btn')}
            </button>
          </div>
      ...
      {socialSettings && (socialSettings.facebook || socialSettings.tiktok || socialSettings.instagram || socialSettings.telegram) && (
        <section className="py-16 bg-teal-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 className="text-5xl md:text-6xl font-playfair text-white tracking-tight italic drop-shadow-md mb-4">
            ...
            <div className="grid grid-cols-2 md:flex md:items-center justify-items-center md:justify-center gap-8 md:gap-16">
              {socialSettings.facebook && (
                ...
                >
                  <div className="w-32 h-32 md:w-48 md:h-48 rounded-[2rem] md:rounded-[3rem] bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-[#1877F2] group-hover:border-[#1877F2] transition-all duration-300 shadow-lg">
                    <svg className="w-14 h-14 md:w-24 md:h-24 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                  </div>
                  <span className="text-white/70 text-xs md:text-sm font-bold uppercase tracking-widest group-hover:text-white transition-colors">Facebook</span>
                </a>
              )}
              {socialSettings.instagram && (
                <a
                  ...
                  className="group flex flex-col items-center gap-3"
                >
                  <div className="w-32 h-32 md:w-48 md:h-48 rounded-[2rem] md:rounded-[3rem] bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-gradient-to-br group-hover:from-[#833AB4] group-hover:via-[#FD1D1D] group-hover:to-[#F77737] group-hover:border-transparent transition-all duration-300 shadow-lg">
                    <svg className="w-14 h-14 md:w-24 md:h-24 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" /></svg>
                  </div>
                  <span className="text-white/70 text-xs md:text-sm font-bold uppercase tracking-widest group-hover:text-white transition-colors">Instagram</span>
                </a>
              )}
              {socialSettings.tiktok && (
                <a
                  ...
                  className="group flex flex-col items-center gap-3"
                >
                  <div className="w-32 h-32 md:w-48 md:h-48 rounded-[2rem] md:rounded-[3rem] bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-black group-hover:border-black transition-all duration-300 shadow-lg">
                    <svg className="w-14 h-14 md:w-24 md:h-24 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" /></svg>
                  </div>
                  <span className="text-white/70 text-xs md:text-sm font-bold uppercase tracking-widest group-hover:text-white transition-colors">TikTok</span>
                </a>
              )}
              {socialSettings.telegram && (
                <a
                  ...
                  className="group flex flex-col items-center gap-3"
                >
                  <div className="w-32 h-32 md:w-48 md:h-48 rounded-[2rem] md:rounded-[3rem] bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-[#2AABEE] group-hover:border-[#2AABEE] transition-all duration-300 shadow-lg">
                    <svg className="w-14 h-14 md:w-24 md:h-24 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" /></svg>
                  </div>
                  <span className="text-white/70 text-xs md:text-sm font-bold uppercase tracking-widest group-hover:text-white transition-colors">Telegram</span>
                </a>
              )}
            </div>
          </div>
      ...
      <section className="bg-teal-50/50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-8">
            ...
            <h2 className="text-4xl font-playfair text-teal-900 tracking-tight">{t('home.blog.title')}</h2>
          </div>
          ...
          {featuredBlogs.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <button onClick={() => setView('blog')} className="mt-4 text-teal-700 font-bold hover:text-teal-900 transition-colors">
          ...
          <div className="text-center mt-10">
            <button
              onClick={() => setView('blog')}
              className="border-2 border-teal-900 text-teal-900 px-8 py-3 font-bold hover:bg-teal-900 hover:text-white transition-all rounded-sm uppercase tracking-widest text-sm"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-teal-900 rounded-sm p-8 md:p-16 text-center relative overflow-hidden">
          {/* Abstract Background Elements */}
          <div className="absolute top-0 left-0 w-64 h-64 bg-white/5 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl" />
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-teal-700/20 rounded-full translate-x-1/2 translate-y-1/2 blur-3xl" />

          <div className="relative z-10 max-w-2xl mx-auto space-y-8">
            <div className="space-y-4">
              <span className="text-teal-200 font-bold tracking-[0.4em] text-xs uppercase">{t('home.sub.subtitle')}</span>
              <h2 className="text-4xl md:text-5xl font-playfair text-white tracking-tight">{t('home.sub.title')}</h2>
            ...
            <form className="flex flex-col sm:flex-row gap-4" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 bg-white/10 border border-white/20 px-6 py-4 text-white placeholder:text-white/40 focus:ring-2 focus:ring-teal-200 focus:border-transparent rounded-sm outline-none transition-all"
              />
              <button className="bg-white text-teal-900 px-10 py-4 font-black uppercase tracking-widest text-sm hover:bg-teal-50 transition-all rounded-sm shadow-xl">
                {t('home.sub.btn')}
              </button>
            </form>
            <p className="text-teal-100/40 text-[10px] uppercase tracking-widest">
              {t('home.sub.note')}
            </p>
          </div>
        </div>
