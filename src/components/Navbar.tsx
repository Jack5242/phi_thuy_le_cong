        ...
        <div className={`flex items-center justify-between transition-all duration-500 border-b border-white/5 ${isScrolled ? 'py-2' : 'py-4'}`}>
          ...
          >
            <div className="flex items-center justify-center gap-1 md:gap-4 md:-translate-x-2 transition-transform duration-500">
              ...
              />
              <h2
                className="text-[clamp(13px,4vw,36px)] font-brand italic tracking-widest uppercase leading-tight py-1 whitespace-nowrap drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] transition-colors duration-300"
            ...
            <div className="flex items-center gap-2 md:gap-3 w-full mt-0 md:mt-0">
